// Version debug pour l'affichage des réponses
console.log('=== ANSWERS DEBUG VERSION START ===');
...
document.addEventListener('DOMContentLoaded', () => {
  console.log('=== ANSWERS DEBUG VERSION INIT ===');
  ...
  console.log('=== ANSWERS DEBUG VERSION READY ===');
});

console.log('=== ANSWERS DEBUG VERSION LOADED ===');
